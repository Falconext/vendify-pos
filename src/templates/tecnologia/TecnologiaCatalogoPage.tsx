 ...
 * Catálogo del template Tecnologia extraído de Catalogo.tsx.
 */
...
export default function TecnologiaCatalogoPage({
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA]" style={{ fontFamily: `'${diseno.tipografia || 'Inter'}', sans-serif` }}>
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">
              ...
              {(selectedCategorías[0] || selectedMarcas[0] || search) && (
                <span> para "{selectedCategorías[0] || selectedMarcas[0] || search}"</span>
              )}
            </p>
          </div>
      ...
      <TecnologiaFooter tienda={tienda || {}} slug={slug || ''} diseno={diseno} categories={allCategorías} />
