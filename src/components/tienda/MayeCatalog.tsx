...
export default function MayeCatalog({ demo, cp, onProduct, onAddToCart }: MayeCatalogProps) {
    ...
    <div className="bg-[#FAF5F5] min-h-screen pb-16 font-sans">
      ...
      <div className="bg-[#111111] relative overflow-hidden text-white pt-20 pb-24 px-6 mb-12">
        <div className="absolute inset-0 z-0 opacity-40">
           <img src="/assets/templates/maye/catalogo.png" className="w-full h-full object-cover mix-blend-luminosity" alt="Background" />
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">Encuentra los mejores equipos y accesorios para tu setup con la garantía y respaldo que mereces.</p>
        </div>
      </div>
