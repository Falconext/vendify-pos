...
export default function ProductCardAutopartes({ producto, slug, diseno, onAddToCart, onClick }: ProductCardProps) {
    const [imageLoaded, setImageLoaded] = useState(false);
    const isOutOfStock = Number(producto.stock) <= 0;
    
    // We simulate rating for demo
    ...
    return (
        ...
        >
            ...
            <div className="absolute top-4 left-4 z-10">
                <span className="bg-[#00C4B5] text-white text-[10px] font-bold px-2.5 py-1 rounded-sm uppercase tracking-wide">
                    En Oferta
                </span>
            </div>
            ...
            <div className="flex flex-col flex-1">
                ...
                <div className="flex items-center gap-1.5 mb-3">
                    ...
                    <span className="text-[10px] text-gray-400 font-medium">135k Reseñas</span>
                </div>
                ...
                <div className="mt-auto flex items-baseline gap-2 mb-4">
                    {producto.precioOriginal && Number(producto.precioOriginal) > Number(producto.precioUnitario) ? (
                        ...
                        <>
                            <span className="text-sm text-gray-400 line-through font-medium">
                                S/ {(Number(producto.precioUnitario) * 1.3).toFixed(2)}
                            </span>
                            <span className="text-lg font-black text-red-600">
                                S/ {Number(producto.precioUnitario).toFixed(2)}
                            </span>
