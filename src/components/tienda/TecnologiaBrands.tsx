...
export default function TecnologiaBrands({ cp, slug, diseno }: Props) {
  const navigate = useNavigate();
  const brandsImage = diseno?.tecnologiaBrandsImageUrl || '/assets/templates/tecnologia/marcas.png';

  const brands = [
    { name: 'AYD', logo: '/assets/templates/tecnologia/producto.png' },
    { name: 'Rolex', logo: '/assets/templates/tecnologia/producto.png' },
    { name: 'Xenery', logo: '/assets/templates/tecnologia/producto.png' },
    { name: 'Aqua Plus', logo: '/assets/templates/tecnologia/producto.png' },
    { name: 'APC', logo: '/assets/templates/tecnologia/producto.png' },
    { name: 'Ariete', logo: '/assets/templates/tecnologia/producto.png' },
    { name: 'Arnott', logo: '/assets/templates/tecnologia/producto.png' },
    { name: 'As Catalizadores', logo: '/assets/templates/tecnologia/producto.png' },
    { name: 'Apple', logo: '/assets/templates/tecnologia/producto.png' },
    { name: 'Ashika', logo: '/assets/templates/tecnologia/producto.png' },
    { name: 'Asmet', logo: '/assets/templates/tecnologia/producto.png' },
    { name: 'Axpock', logo: '/assets/templates/tecnologia/producto.png' },
    { name: 'Aster', logo: '/assets/templates/tecnologia/producto.png' },
    { name: 'Autoteile', logo: '/assets/templates/tecnologia/producto.png' },
    { name: 'Auger', logo: '/assets/templates/tecnologia/producto.png' },
  ];
