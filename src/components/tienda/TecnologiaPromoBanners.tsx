...
interface TecnologiaPromoBannersProps {
  cp: string;
  slug: string;
  diseno?: any;
}

export default function TecnologiaPromoBanners({ cp, slug, diseno }: TecnologiaPromoBannersProps) {
  const navigate = useNavigate();
  const promoLeftImage = diseno?.tecnologiaPromoLeftImageUrl || '/assets/templates/tecnologia/llantas.png';
  const promoRightImage = diseno?.tecnologiaPromoRightImageUrl || '/assets/templates/tecnologia/luces.png';
