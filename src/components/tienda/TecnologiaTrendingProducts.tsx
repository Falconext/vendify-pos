...
export default function TecnologiaTrendingProducts({ cp, slug, productos, diseno, onAddToCart }: Props) {
  ...
  const comunidadImage = diseno?.tecnologiaCommunityImageUrl || '/assets/templates/tecnologia/comunidad.png';
  const supportImage = diseno?.tecnologiaSupportImageUrl || '/assets/templates/tecnologia/asistencia.png';
