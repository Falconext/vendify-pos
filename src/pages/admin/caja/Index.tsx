            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-5">
                <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                        <h1 className="text-[22px] font-extrabold text-slate-800 tracking-tight truncate">Gestión de Caja</h1>
                        <p className="text-sm text-slate-400 mt-0.5">Control de turnos, apertura, cierre y reportes de caja.</p>
                    </div>
                </div>
            </div>
