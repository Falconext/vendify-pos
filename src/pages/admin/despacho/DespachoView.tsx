        ...
        <div className="min-h-screen -m-5 p-5 bg-[#F7F8FB] font-jakarta" style={{ ['--accent' as any]: ACCENT }}>
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-5">
                <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                        <h1 className="text-[22px] font-extrabold text-slate-800 tracking-tight truncate">Panel de Despacho</h1>
                ...
                <div className="flex items-center gap-2.5">
                    ...
                    <button
                        ...
                        className="relative top-2 h-11 w-11 grid place-items-center rounded-2xl border border-slate-200 bg-white text-emerald-600 hover:bg-emerald-50 transition-colors shrink-0"
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 mb-5">
                {[
                    ...
                    <div key={k.label} className="bg-white rounded-3xl shadow-[0_2px_20px_rgba(15,23,42,0.05)] p-4 flex items-center gap-3">
                    ...
                    <div className="flex gap-2 overflow-x-auto pb-1">
                        ...
                        <button
                            ...
                            style={filtroRepartidor === undefined
                                ...
                                : undefined}
                        >
                            <span className={filtroRepartidor === undefined ? '' : 'text-slate-600'}>TODOS</span>
                        </button>
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-1.5">
                                        <span className={`inline-flex items-center gap-1 rounded-md px-1.5 py-0.5 text-[10px] font-bold ${isSelected ? 'bg-amber-400/30 text-amber-50' : 'bg-amber-50 text-amber-600'}`}>
                                            <span>{rep.preparando}</span>
                                            <Icon icon="solar:clock-circle-bold" className="text-[10px]" />
                                        </span>
                                        <span className={`inline-flex items-center gap-1 rounded-md px-1.5 py-0.5 text-[10px] font-bold ${isSelected ? 'bg-blue-400/30 text-blue-50' : 'bg-blue-50 text-blue-600'}`}>
                                            <span>{rep.enCamino}</span>
                                            <Icon icon="solar:delivery-bold" className="text-[10px]" />
                                        </span>
                                        <span className={`inline-flex items-center gap-1 rounded-md px-1.5 py-0.5 text-[10px] font-bold ${isSelected ? 'bg-emerald-400/30 text-emerald-50' : 'bg-emerald-50 text-emerald-600'}`}>
            ...
            <div className="bg-white rounded-3xl shadow-[0_2px_20px_rgba(15,23,42,0.05)] overflow-hidden">
                ...
                <div className="flex flex-wrap items-center gap-2.5 p-4 border-b border-slate-100">
                    <div className="relative flex-1 min-w-[220px]">
                        ...
                        <input
                            ...
                            className="w-full h-11 pl-10 pr-3 rounded-2xl border-2 border-slate-200 bg-white text-sm text-slate-700 placeholder:text-slate-400 focus:outline-none focus:border-[var(--accent)] transition-colors"
                        />
                    </div>
                    <button
                        ...
                        style={!filtroEstado
                            ...
                            : undefined}
                    >
                        <span className={!filtroEstado ? '' : 'text-slate-600'}>Todos</span>
                    </button>
                    {ESTADOS_DESPACHO.map(e => (
                        <button
                            key={e.value}
                            onClick={() => setFiltroEstado(filtroEstado === e.value ? '' : e.value)}
                            className={`h-9 px-3.5 rounded-xl text-sm font-semibold transition-colors ${filtroEstado === e.value ? 'bg-slate-900 text-white' : 'border border-slate-200 text-slate-600 hover:bg-slate-50'}`}
                        >
                            {e.label}
                        </button>
                    ))}
                ...
                {loading ? (
                    ...
                    <div className="flex flex-col items-center py-20 text-slate-400">
                        <Icon icon="solar:delivery-bold-duotone" className="text-5xl text-slate-200 mb-3" />
