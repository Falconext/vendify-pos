                    ...
                    <div className={`${cardCls} p-5 lg:order-2 ${configTab}`}>
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                {/* ── Observaciones por defecto de la venta ── */}
                                <div className="mt-3 p-3 rounded-lg border border-amber-100 dark:border-amber-900/30 bg-amber-50/40 dark:bg-amber-900/10">
                                    <p className="text-sm font-semibold text-slate-800 dark:text-slate-100">Observaciones por defecto de la venta</p>
                                    ...
                                    <textarea
                                        ...
                                        className="w-full rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 px-3 py-2 text-sm text-slate-800 dark:text-slate-100 focus:outline-none focus:border-[var(--accent)] transition-colors"
                                    />
                                    <div className="mt-2 flex items-center justify-between gap-2">
                                        <span className="text-[11px] text-slate-400">{vm.ventaObsDefault.length}/600</span>
                                        <button
                                            type="button"
                                            disabled={!vm.ventaObsDirty || vm.savingVentaObs}
                                            onClick={vm.handleVentaObsSave}
